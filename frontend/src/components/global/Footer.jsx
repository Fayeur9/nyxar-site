...
const SOCIAL_LINKS = {
    discord: 'https://discord.gg/4Ud5BRZTbT',
    twitter: 'https://x.com/nyxar_esport',
    twitch: 'https://www.twitch.tv/nyxartv_',
    youtube: 'http://youtube.com/@NyxarEsport',
    tiktok: 'https://www.tiktok.com/@best_of_nyxar'
}
        ...
        <footer className="footer">
            <div className="footer-container">
                ...
                <div className="footer-sponsors">
                    {sponsors.length > 0 && (
                        <>
                            <span className="footer-sponsors__title">Nos Sponsors</span>
                            <div className="footer-sponsors__grid">
                ...
                <div className="footer-socials">
                    ...
                    <a href={SOCIAL_LINKS.twitch} target="_blank" rel="noopener noreferrer" aria-label="Twitch">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                {/* Droite - Copyright et texte */}
                <div className="footer-info">
                    <p className="footer-text">NYXAR - Equipe e-sport depuis mars 2025</p>
                    <p className="footer-copyright">&copy; {new Date().getFullYear()} NYXAR. Tous droits réservés.</p>
                </div>
            </div>
        </footer>
    )
